  ...
  <div class="row">
    <div class="col-md-4">
      <div class="panel panel-success">
        <div class="panel-heading">HP Core i3 - (4 GB/1 TB HDD/DOS) X5Q17PA 15-be005TU Notebook</div>
        <div class="panel-body"><img src="hp1.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>Intel Core i3 Processor ( 5th Gen )</li><br>
    <li>4 GB DDR3 RAM</li><br>
    <li>DOS Operating System</li><br>
    <li>1 TB HDD</li><br>
    <li>15.6 inch Display</li><br></ul></div>
        <div class="panel-footer"><center>Price: Rs 24990/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="panel panel-success">
        <div class="panel-heading">HP Core i5 - (8 GB/1 TB HDD/DOS/2 GB Graphics)</div>
        <div class="panel-body"><img src="hp2.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>Intel Core i5 Processor ( 6th Gen )</li><br>
    <li>8 GB RAM</li><br>
    <li>DOS Operating System</li><br>
    <li>1 TB HDD</li><br>
    <li>15.6 inch Display</li><br></ul></div>
        <div class="panel-footer"><center>Price: Rs 42990/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="panel panel-success">
        <div class="panel-heading">HP Spectre Core i5</div>
        <div class="panel-body"><img src="hp3.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>Intel Core i5 Processor ( 5th Gen )</li><br>
    <li>8 GB RAM</li><br>
    <li>64 bit Windows 10 Operating System</li><br>
    <li>256 GB SSD</li><br>
    <li>13.3 inch Display</li><br></ul>
		</div>
        <div class="panel-footer"><center>Price: Rs 105000/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
  </div>
</div><br>
