  ...
  <div class="row">
    <div class="col-md-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Sony 80cm (32) HD Ready LED TV</div>
        <div class="panel-body"><img src="sonytv1.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>HD Ready | 1366 x 768 Resolution</li><br>
    <li>178 degree Viewing Angle</li><br>
    <li>10 W Speaker Output</li><br></ul></div>
        <div class="panel-footer"><center>Price: Rs 22990/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Sony BRAVIA KDL-40W700C 101.6 cm (40) Full HD LED TV  </div>
        <div class="panel-body"><img src="sonytv2.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>Full HD</li><br>
    <li>178&deg; degree Viewing Angle</li><br>
    <li>10 W x 2 W Speaker Output</li><br>
    <li>1 (Rear) Audio Output</li><br></ul></div>
        <div class="panel-footer"><center>Price: Rs 57900/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="panel panel-primary">
        <div class="panel-heading">Sony 123cm (49) Ultra HD (4K) Smart LED TV</div>
        <div class="panel-body"><img src="sonytv3.jpeg" class="img-responsive" style="width:50%" alt="Image">
	<ul><li>Ultra HD (4K) | 3840 x 2160 Resolution</li><br>
    <li>178 degree Viewing Angle</li><br>
    <li>20 W Speaker Output</li><br>
    <li>1 (Rear) Audio Output</li><br></ul>
		</div>
        <div class="panel-footer"><center>Price: Rs 115500/-<br><a href="#">Buy Now!</a></center></div>
      </div>
    </div>
  </div>
</div><br>
